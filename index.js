const onClickRow = (number) => {
  ...
  switch (number) {
    case 1:
      if (
        document.querySelector("#row1").classList[1] === "hidden" &&
        document.querySelector("#r-content1").classList[1] === "hidden"
      ) {
        reset();
    ...
    case 2:
      if (
        document.querySelector("#row2").classList[1] === "hidden" &&
        document.querySelector("#r-content2").classList[1] === "hidden"
      ) {
        reset();
    ...
    case 3:
      if (
        document.querySelector("#row3").classList[1] === "hidden" &&
        document.querySelector("#r-content3").classList[1] === "hidden"
      ) {
        reset();
